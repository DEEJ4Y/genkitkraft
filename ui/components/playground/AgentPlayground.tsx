...
export function AgentPlayground({ agent }: AgentPlaygroundProps) {
  ...
  const [config, setConfig] = useState<PlaygroundConfig>({
    ...
    temperatureEnabled: agent.temperatureEnabled,
    temperature: agent.temperature,
    topPEnabled: agent.topPEnabled,
    topP: agent.topP,
  ...
  const chat = usePlaygroundChat({
    ...
    config: {
      ...
      temperatureEnabled: config.temperatureEnabled !== agent.temperatureEnabled ? config.temperatureEnabled : undefined,
      temperature: config.temperature !== agent.temperature ? config.temperature : undefined,
      topPEnabled: config.topPEnabled !== agent.topPEnabled ? config.topPEnabled : undefined,
