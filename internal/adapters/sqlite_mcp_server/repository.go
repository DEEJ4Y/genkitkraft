...
// McpServerRepository implements mcpserverrepo.McpServerRepository using SQLite.
type McpServerRepository struct {
	db *sql.DB
}

// NewMcpServerRepository creates a new SQLite-backed MCP server repository.
