...
// HttpToolRepository implements httptoolrepo.HttpToolRepository using MySQL.
type HttpToolRepository struct {
	db *sql.DB
}

// NewHttpToolRepository creates a new MySQL-backed HTTP tool repository.
